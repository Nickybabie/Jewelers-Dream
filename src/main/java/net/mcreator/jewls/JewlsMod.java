...
@Mod("jewls")
public class JewlsMod {
	public static final Logger LOGGER = LogManager.getLogger(JewlsMod.class);
	public static final String MODID = "jewls";
	...
	public JewlsMod() {
		...
		JewlsModFeatures.REGISTRY.register(bus);
