...
public class MalachiteOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("jewls:malachite_ore", FEATURE,
				new OreConfiguration(MalachiteOreFeatureRuleTest.INSTANCE, JewlsModBlocks.MALACHITE_ORE.get().defaultBlockState(), 7));
		PLACED_FEATURE = PlacementUtils.register("jewls:malachite_ore", CONFIGURED_FEATURE, List.of(CountPlacement.of(11), InSquarePlacement.spread(),
	...
	private static class MalachiteOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("jewls:malachite_ore_match"), CUSTOM_MATCH);
		}
		...
		public boolean test(BlockState blockAt, Random random) {
			if (base_blocks == null) {
				base_blocks = List.of(Blocks.STONE, Blocks.COAL_ORE, Blocks.IRON_ORE);
			}
