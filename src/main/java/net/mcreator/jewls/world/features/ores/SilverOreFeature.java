...
public class SilverOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("jewls:silver_ore", FEATURE,
				new OreConfiguration(SilverOreFeatureRuleTest.INSTANCE, JewlsModBlocks.SILVER_ORE.get().defaultBlockState(), 7));
		PLACED_FEATURE = PlacementUtils.register("jewls:silver_ore", CONFIGURED_FEATURE, List.of(CountPlacement.of(11), InSquarePlacement.spread(),
	...
	private static class SilverOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("jewls:silver_ore_match"), CUSTOM_MATCH);
		}
